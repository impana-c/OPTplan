    ...
    return (
        <section>
          <div className="container about__container">
            ...
            <p>Currently, double majoring is supported, and additional support will be added for other double majors, minors, and CS-adjacent majors. More is on the way! :)</p>
